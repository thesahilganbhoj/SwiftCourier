...
function UpdatePassword(props) {
  ...
  const updatePassword = (event) => {
    ...
    if (confirmNewPassword !== passwords.newPassword) {
      ...
      privateAxios.patch(`/employee/profile/${id}`, passwords)
        .then(response => {
  ...
  return (
    <div className='container my-5'>
      ...
      <form>
        ...
        <button type='button' className='btn btn-outline-warning' onClick={() => props.setCurrentComponent('Profile')}>Cancel</button>
